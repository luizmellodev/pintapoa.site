      ...
      <div className="w-full max-w-xl sm:max-w-2xl md:max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center">
            ...
            <h1 className="text-xl sm:text-2xl font-extralight tracking-wider yellow-text">Painel de Administração</h1>
          </div>
              ...
              <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-transparent hover:bg-emerald-400/10 text-emerald-400 border border-emerald-400/30 rounded-none font-extralight tracking-wider">
                    <PlusCircle className="h-4 w-4 mr-2" /> {isMobile ? "NOVO" : "ADICIONAR LOCAL"}
                  </Button>
                </DialogTrigger>
        ...
        <motion.h2
          className="text-lg sm:text-xl font-extralight mb-4 sm:mb-6 tracking-wide yellow-text border-b border-yellow-400/20 pb-2"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
